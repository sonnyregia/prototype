...
class Kembali_model extends CI_Model
{
    ...
    function add_kembali($params)
    {
        $this->db->insert('barang_aset_kembali',$params);
        return $this->db->insert_id();
    }

         function get_all_barang_kembali()
    {
        $this->db->order_by('id_aset_kembali', 'asc');
        return $this->db->get('barang_aset_kembali')->result_array();
    }
