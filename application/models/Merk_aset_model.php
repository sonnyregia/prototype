...
class Merk_aset_model extends CI_Model
{

    public $table = 'merk_aset';
    public $id = 'id_merk_aset';
    public $order = 'DESC';
    ...
    function get_all_merk()
        {
            $this->db->order_by('merk_aset', 'asc');
            return $this->db->get('merk_aset')->result_array();
        }
}
