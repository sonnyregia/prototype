...
<body >
	...
	$rs = $data->row();
	 ?>
	<div class="row">
		<p><a class="btn btn-info btn-lg" href="<?php echo base_url('barang_masuk/export_excel') ?>">Export ke Excel</a></p>
		<div class="col-md-12">
			<table class="table table-bordered" style="margin-bottom: 10px" >
				...
				<tbody>
					<?php 
					$sql = $this->db->query("SELECT * FROM barang_masuk as a,barang as b where a.kode_barang=b.kode_barang");
					$no = 1;
